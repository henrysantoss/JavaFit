...
public class telaUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        edtLogin.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel5.setText("Senha:");

        edtSenha.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseClicked
        String sql_gerador = "select * from USUARIO";
        ...
        if (edtNome.getText().isEmpty()) {
            ...
            try{
                ...
                if(rs.next()){
                    while(rs.next()){
                        gen = Integer.valueOf(rs.getString("id_usuario"));
                    }
                    gen ++;
                }
                else {
